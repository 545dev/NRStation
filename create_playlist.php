  ...
  <section class="vbox">
    ...
    <section>
      <section class="hbox stretch">
        ...
        <!-- /.aside -->
        <section id="content">
        <h2 class="font-thin m-b">&nbsp&nbsp&nbspCrea la tua playlist<span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
            ...
            <section class="scrollable padder">
              <section class="panel panel-default">
                ...
                <div class="row wrapper">
                  ...
                  <form class="form-inline" role="form" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" data-validate="parsley">
                    <div class="form-group">
                      <input type="text" class="form-control" placeholder="Nome Playlist" name ="nomeplay" class="form-control" data-required="true">&nbsp
                      <button type="submit" name="createfile" class="btn btn-success btn-s-xs">Crea Playlist</button>
                    </div>
                    </div>                
                  </div>
                </div>
                  ...
                  <table class="table table-striped b-t b-light">
                    <thead>
                      <tr>
                        ...
                        <th class="th-sortable" data-toggle="class">Titolo Canzone
                          <span class="th-sort">
                    ...
                    <tbody class="scrollable padder-v">
                    <?php include ("core/create_play.php"); ?>
                    </tbody>
                  </table>
                </div>
              </form>
